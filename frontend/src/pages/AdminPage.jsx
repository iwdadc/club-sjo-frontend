  ...
  function AdminPage() {
    ...
    return (
      ...
      {/* MODULO ALUMNOS */}
      {moduloActivo === 'alumnos' && (
        <div className="flex items-center justify-center h-64">
          <p className="text-gray-400 text-sm">Módulo Alumnos en construcción</p>
        </div>
      )}
      {/* MODULO CLASES */}
      {moduloActivo === 'clases' && (
        <div className="flex items-center justify-center h-64">
          <p className="text-gray-400 text-sm">Módulo Clases en construcción</p>
        </div>
      )}
      {/* MODULO PROFESORES */}
